...
#   minutes_given = 10
    ...
    raven_intro_para_1 = translation_dict["raven_intro"]["paragraph_1"][LANGUAGE_CODE].format(num_rounds)
    raven_intro_para_2 = translation_dict["raven_intro"]["paragraph_2"][LANGUAGE_CODE].format(payment_in_points)
    raven_intro_para_3 = translation_dict["raven_intro"]["paragraph_3"][LANGUAGE_CODE].format(payment_per_question)
    raven_intro_para_4 = translation_dict["raven_intro"]["paragraph_4"][LANGUAGE_CODE].format(minutes_given)
    ...
    raven_question_title1 = translation_dict["raven_question"]["title_part1"][LANGUAGE_CODE]
    raven_question_title2 = translation_dict["raven_question"]["title_part2"][LANGUAGE_CODE]
