...
translation_dict = {
	...
	"raven_intro" : {
		...
		"paragraph_1" : {
			"en" : "You will be presented with 12 problems, each showing a pattern with a bit cut out of it. Look at the pattern, think what piece is needed to complete the pattern correctly both along the rows and down the columns, BUT NOT THE DIAGONALS.",
			"he" : ""
		},
		"paragraph_2" : {
			"en" : "You will be paid 3 points for each correct problem you solve.",
			"he" : ""
		},
		"paragraph_3" : {
			"en" : "You will be paid 1 for each correct problem you solve.",
			"he" : ""
		},
		"paragraph_4" : {
			"en" : "You will have 2 minutes to complete all problems.",
			"he" : ""
		},
		"paragraph_5" : {
